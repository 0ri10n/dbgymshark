...
const AdminPanel = () => {
    ...
    const cargarProductos = async () => {
        setCargando(true);
        try {
            // Paginado de 10 productos por página
            ...
            if (res.data.productos) {
                ...
                // Contador dinámico basado en la suma de todos los elementos en la DB
    ...
    // --- LÓGICA DE VARIANTES (AGRUPACIÓN POR COLOR E IMAGEN) ---
    ...
    return (
        <div className="admin-container">
            ...
            <main className="admin-main">
                ...
                {/* PAGINADO REAL PARA 500+ PRODUCTOS */}
            ...
            {/* MODAL PRODUCTO - BOTÓN AÑADIR COLOR A LA DERECHA */}
            {modalAbierto && (
                        ...
                        <form onSubmit={handleGuardar} className="admin-form-vertical">
                            ...
                            <div className="variants-section">
                                <div className="section-header-right">
                                    ...
                                    {/* Botón alineado a la derecha con margen */}
                                ...
                                {variantsByColor.map((group, idx) => (
                                    <div key={idx} className="color-group-card">
                                        ...
                                        {/* Previsualización de imagen pequeña centrada debajo de la URL */}
                                        {group.image && (
                                        ...
                                        <div className="sizes-grid">
                                            ...
                                            {/* Botón para añadir talla adicional al mismo color */}
